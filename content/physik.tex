...
Der Zusammenhang der Grössen durch Differentiation gilt auch umgekehrt. So kann die Geschwindigkeit
...
wird für g jeweils der mittlere Wert von 9.81$\frac{m}{s^2}$ angenommen.  
...
Impuls ist. Diese Zusammenhänge zeigt die \autoref{fig:kraftstoss}. (Abschnitt basierend auf dem Unterrichtsskript Physik der Hochschule Luzern \cite{Mechanik} und \cite{Ruhm})
	\begin{SCfigure}
		%\vspace{0.2cm}
		\centering
...
\section{Grundmodell des Masse-Dämpfer-Feder-Prozesses} \index{Masse-Dämpfer-Feder-Prozess}
	...
	\begin{figure}
		...
		\caption[Einfachster Masse-Dämpfer-Feder Prozess]{Einfachster Masse-Dämpfer-Feder Prozess \cite{Ruhm}}
...
\section{Druck-Sogwellen eines Zuges} \label{Durck-Sogfeld} \index{Sog-Druck Feld}
	...
	einen Sog-Druckwechsel. In diesen Momenten entstehen die grössten Druckdifferenzen. Ebenfalls grosse
	...
	\end{SCfigure}
	Der Abstand zwischen Durck- und Sogwelle L hängt nicht von der Zugsgeschwindigkeit $v_{Zug}$ ab,
	...
	Im Gegensatz zum Abstand L ist der zeitliche Abstand von $v_{Zug}$ abhängig. Bei der maximalen Durchfahrtsgeschwindigkeit an Bahnhöfen von 200km/h
	beträgt diese somit im Minimum $\Delta t = \frac{s}{v}=124ms$. Je grösser der Wandabstand, desto grösser der Abstand 
	zwischen Durck- und Sogwelle und desto länger wird auch der zeitliche Abstand. Somit wird die dynamische Anregung verlängert \cite{Niemann}. 
	Für Systeme mit einer Eigenfrequenz oberhalb der dynamischen Anregung sinkt dadurch die Gefahr zu schwingen. 