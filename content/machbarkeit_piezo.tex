\chapter{Versuche mit piezoelektrischen Sensoren} \label{chap:piezo}
	...
	\begin{wrapfigure}[10]{r}{6.5cm}
		\centering
		\vspace{-1cm}
		\includegraphics[width=6cm]{img/ks93.png}
		\caption{Miniatursensor KS93}
		\label{fig:ks93}
	\end{wrapfigure}
	Für die ersten Versuche werden piezoelektrische Sensoren des Typs KS93 verwendet. Dieser
	Miniatur-Beschleunigungsaufnehmer hat einen Messbereich von $\pm 6000$g und einen linearen
	Frequenzbereich bis 22kHz. Am Sensorausgang ändert sich je nach Beschleunigung die Ladung Q. Diese
	muss mit einem Ladungsverstärker in eine Spannung umgewandelt und verstärkt werden. Der
	Ladungsübertragungsfaktor beträgt 4.875 pC/g. Weiter Eigenschaften des Sensors sind dem Datenblatt
	zu entnehmen \cite{KS93}.
	...
	Das Signal mit wird mit dem Ladungsverstärker gewandelt. Der Signalverlauf wird mit einem
	Oszilloskop aufgezeichnet. 	Die aufgenommenen Beschleunigungssignale werden als Bild und als Daten
	für Matlab exportiert. Auf dem Computer können die Messungen ausgewertet werden.
	\begin{figure}
		\centering
		%\vspace{-1cm}
		\captionsetup{width=7cm}
		\includegraphics[width=7cm]{img/versuchsaufbau_piezo.png}
	...
	Für die Verarbeitung der Daten in Matlab wurden zwei Funktionen geschrieben: readOszData() und 
	...
	g um. Dabei kann die eingestellte Verstärkung am Ladungsverstärker als Parameter mitgegeben werden. 
	\lstset{
...
\newpage		
\section{Ergebnisse der Versuche mit piezoelektrischen Sensoren}
	\subsection{Zu erwartende Signale bei Vandalismus} \label{subsec:signale}
		...
		sichtbar. 
	\newpage	
	\subsection{Beste Positionierung} \label{subsec:bestPos}
