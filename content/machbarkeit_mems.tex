\chapter{Versuche mit dem MEMS-Sensor Datenlogger} 
	...
	\section{Versuch mit dem Datenlogger}
		...
		\begin{wrapfigure}[10]{r}{8.5cm}
			\centering
			\vspace{-0.8cm}
			\includegraphics[width=8.5cm]{img/mems_montage.jpg}
		...
		Die \autoref{fig:vergl_mems_piezo} zeigt die Beschleunigungssignale am Uhrwerk gemessen mit dem piezoelektrischen 
		Sensor wie in \autoref{chap:piezo} und jenen gemessen mit dem MEMS-Sensor. Die beiden Messungen unterscheiden sich 
		in der Abtastrate. Der Signalverlauf der piezoelektrischen Sensoren wird mit dem Oszilloskop mit einer Abtastfrequenz von
		500kHz abgetastet. Die Abtastrate des MEMS-Sensor kann maximal 1kHz betragen. Diesen Unterschied erkennt man 
		darin, dass die sehr kurzen, hohen Beschleunigungspeaks mit dem MEMS-Sensor nicht erfasst werden. Mit einer Abtastrate des MEMS-Sensors von 
		400Hz wird jedoch die für diese Anwendung interessante Eigenfrequenz des Ziffernblattes 
		von 50Hz erfolgreich sichtbar. 
		\begin{SCfigure}
			\centering
			\vspace{-1cm}
