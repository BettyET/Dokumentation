...
Produkt unterteilt. Die Anforderungen an das Produkt sind für die Machbarkeitsstudie noch nicht
relevant.
\\
\begin{longtable}{p{0.5cm} p{0.5cm} p{8.5cm} p{2cm} } \toprule
	...
	2 &  	& 	Der Vandalismus muss von Windböen und der Sog-Druckwelle 
				eines Zuges unterschieden werden können. 						& Forderung \\		
	...
	5 & 	& 	Es soll abgeklärt werden, ob die Implementierung auf dem
	  ...
	  &	5.1	&	Falls die Implementierung auf dem ATMEL- Kontroller nicht
				...
				anderen Komponenten benötigt werden.							& Forderung \\
	...
	7 & 	& 	Es soll abgeklärt werden, ob eine vorhandene Schnittstelle 
				(SPI, I2C, UART) verwendet werden kann.							& Wunsch \\
	\\
	...
	2 & 	& 	Der Alarm soll mittels SNMP über die bestehende Uhrsteuerung
				abgesetzt werden können.										& Forderung \\
	3 &		&	Die Kosten für den Sensor liegen im Breich von 5 bis maximal 10 Fr.
				pro Stück.														& Forderung \\
